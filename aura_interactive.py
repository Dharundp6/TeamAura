...
def interactive_mode():
    """Run AURA agent interactively to avoid rate limits"""
    
    agent = AURAAgent()
    
    print("=" * 70)
    print("AURA Network Operations Agent - Interactive Mode")
    print("=" * 70)
    print("\nCommands:")
    ...
    scenarios = {
        ...
        '2': "The fiber link issue looks correct. Please propose a remediation plan and ask for approval if needed.",
        '3': "You are approved to proceed with the NTN failover.",
        '4': "APPROVED",
    }
